      ...
      >
        ...
        <ul className="match-modal__list">
          {matches.map(
            ...
            <li
              key={reportId}
              className={`match-card match-card--${matchType}`}
            >
              <h3 className={`match-card__banner match-card__banner--${matchType}`}>
                {levelHeaders[matchType] ?? t('match.headerDefault', 'Match Found')}
              </h3>
              ...
              <div className="match-card__body">
                <dl className="match-card__meta">
                  ...
                  <div>
                    ...
                    <dd className="match-card__score">{matchScore}%</dd>
                  </div>
                </dl>
